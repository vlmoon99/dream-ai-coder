...
class TemplateModel:
    def __init__(self, author, technology, description, stage, llm_response_template, user_prompt_template, example, standard_of_saving_output, created_at=None, updated_at=None, _id=None):
